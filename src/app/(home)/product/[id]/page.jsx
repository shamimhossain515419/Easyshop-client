               ...
               <Container>
                    <div className=' boxShadow p-4  md:grid grid-cols-2 gap-5  mt-4'>
                         <div className=' p-3 text-end'>
                              <Image width={500} height={400} className=' block   text-center mx-auto h-[300px] ' src={data?.image} alt="" />
                         </div>
                         <div className=' '>
                              <div>
                                   ...
                                   <div>
                                        ...
                                        <div className=' flex justify-center gap-3 items-center my-2'>
                                             ...
                                             <div onClick={() => handleAddCard(data?._id)} className=' w-full'>
                                        ...
                                        <div>
                                             ...
                                             <div className=' p-2 my-4 rounded md:flex gap-8 items-center bg-[#76757569]'>
                                                  ...
                                                  <div>
                                                       <Image width={600} height={40} src="https://weblearnbd.net/tphtml/shofy-prv/shofy/assets/img/product/icons/payment-option.png" alt="" />
